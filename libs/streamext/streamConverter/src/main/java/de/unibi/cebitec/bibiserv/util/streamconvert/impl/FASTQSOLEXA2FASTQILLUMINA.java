...
/**
 * Convert fastq variants solexa to illumina.
 * @author Thomas Gatter - tgatter(at)cebitec.uni-bielefeld.de
 */
public class FASTQSOLEXA2FASTQILLUMINA extends AbstractStreamParserConverter {

    @Override
    protected ConversionParser getParser(BufferedReader input, BufferedWriter output) {
        return new FastQToFastQConverter(input,output,FastQVariants.Solexa,FastQVariants.Illumina);
    }
