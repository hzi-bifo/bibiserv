...
/**
 * Convert fastq variants sanger to illumina.
 * @author Thomas Gatter - tgatter(at)cebitec.uni-bielefeld.de
 */
public class FASTQSANGER2FASTQILLUMINA extends AbstractStreamParserConverter {

    @Override
    protected ConversionParser getParser(BufferedReader input, BufferedWriter output) {
        return new FastQToFastQConverter(input,output,FastQVariants.Sanger,FastQVariants.Illumina);
    }
