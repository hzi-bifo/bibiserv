 ...
 */
public class FASTQSANGER2FASTQSOLEXA extends AbstractStreamParserConverter {

    @Override
    protected ConversionParser getParser(BufferedReader input, BufferedWriter output) {
        return new FastQToFastQConverter(input,output,FastQVariants.Sanger,FastQVariants.Solexa);
    }
