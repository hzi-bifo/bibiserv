...
import de.unibi.cebitec.bibiserv.sequence.parser.fastq.FastQToFastaConverter;
 ...
 */
public class FASTQALL2FASTA extends AbstractStreamParserConverter {

    @Override
    protected ConversionParser getParser(BufferedReader input, BufferedWriter output) {
        return new FastQToFastaConverter(input, output);
    }
}
