...
/**
 * Convert fastq variants illumina to sanger.
 * @author Thomas Gatter - tgatter(at)cebitec.uni-bielefeld.de
 */
public class FASTQILLUMINA2FASTQSANGER extends AbstractStreamParserConverter {


    @Override
    protected ConversionParser getParser(BufferedReader input, BufferedWriter output) {
        return new FastQToFastQConverter(input,output,FastQVariants.Illumina,FastQVariants.Sanger);
    }
