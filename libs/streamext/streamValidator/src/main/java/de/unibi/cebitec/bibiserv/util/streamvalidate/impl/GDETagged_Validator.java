...
/**
 * General Implementation of a GDE tagged. 
 * 
 * @author Thomas Gatter - tgatter(at)cebitec.uni-bielefeld.de
 */
public class GDETagged_Validator extends AbstractAlignmentValidator {

    public GDETagged_Validator() {
        super();
        setAlignment(false);
