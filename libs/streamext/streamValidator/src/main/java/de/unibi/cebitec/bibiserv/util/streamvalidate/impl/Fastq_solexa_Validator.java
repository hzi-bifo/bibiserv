...
/**
 * A simple validator for fastq variant solexa.
 *
 * @author Thomas Gatter - tgatter@cebitec.techfak.uni-bielefeld.de
 */
public class Fastq_solexa_Validator extends AbstractSequenceValidator {


    public Fastq_solexa_Validator() {
        super();
    ...
    public InputFormat getInputFormat() {
        return InputFormat.FastQSolexa;
    }
}
