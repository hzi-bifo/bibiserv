...
import de.unibi.cebitec.bibiserv.util.streamvalidate.AbstractAlignmentValidator;

/**
 * General Implementation of a NBRF Validator. Assumes "honeybadger (not specified)" as  
 * default for cardinality, "strict" as default for strictness and "false" for alignment
 * 
 * @author Jan Krueger - jkrueger(at)cebitec.uni-bielefeld.de
 */
public class NBRF_Validator extends AbstractAlignmentValidator {

    public NBRF_Validator() {
        super();
        setAlignment(false);
