...
/**
 * General Implementation of a IG Validator. Assumes "honeybadger (not specified)" as  
 * default for cardinality, "strict" as default for strictness and "false" for alignment
 * 
 * @author Jan Krueger - jkrueger(at)cebitec.uni-bielefeld.de
 */
public class IG_Validator extends AbstractAlignmentValidator {
