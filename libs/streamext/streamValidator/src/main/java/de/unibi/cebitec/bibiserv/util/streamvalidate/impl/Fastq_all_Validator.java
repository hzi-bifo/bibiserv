...
/**
 * A simple validator for all fastq variants .
 * @author Thomas Gatter - tgatter@cebitec.techfak.uni-bielefeld.de
 */
public class Fastq_all_Validator extends AbstractSequenceValidator{

    public Fastq_all_Validator() {
        super();
