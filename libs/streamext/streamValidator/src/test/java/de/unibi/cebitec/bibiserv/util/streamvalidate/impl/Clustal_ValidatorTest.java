...
import de.unibi.cebitec.bibiserv.util.streamvalidate.ValidationException;
 ...
 */
public class Clustal_ValidatorTest extends Abstract_ValidatorTest{
    ...
    //private String clustal_rna_long;
    ...
    public Clustal_ValidatorTest() {
        try {
            ...
            //clustal_rna_long = readFromResource("/clustal_rna_long.cw");
    ...
    @Test
    public void testAminoAcidAlignmentExtended() throws FileNotFoundException {
        validator = new Clustal_Validator();
        validator.setAlignment(true);
        validator.setStrictness(STRICTNESS.strict);
        validator.setContent(CONTENT.AA);
        // -- alignment data
        ValidationResult vr = validator.validateThis( new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/clustal_aa_extended.cw"))));
        assertTrue(vr.getMessage(), vr.isValid());
        
        vr = validator.validateThis( new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/clustal_aa_extended2.cw"))));
        assertTrue(vr.getMessage(), vr.isValid());
    }
    
    @Test
    public void testAminoAcidAlignmentExtendedBroken() throws FileNotFoundException {
        validator = new Clustal_Validator();
        validator.setAlignment(true);
        validator.setStrictness(STRICTNESS.strict);
        validator.setContent(CONTENT.AA);
        // -- alignment data
        ValidationResult vr = validator.validateThis( new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/clustal_aa_extended_broken1.cw"))));
        assertFalse(vr.getMessage(), vr.isValid());
        
        vr = validator.validateThis( new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/clustal_aa_extended_broken2.cw"))));
        assertFalse(vr.getMessage(), vr.isValid());
    }

    
//    @Test
//    public void testRNAAlignemntLong() throws ValidationException {
//        validator = new Clustal_Validator();
//        validator.setAlignment(true);
//        validator.setStrictness(STRICTNESS.strict);
//        validator.setContent(CONTENT.RNA);
//        // -- alignment data
//        ValidationResult vr = validator.validateThis(clustal_rna_long);
//        assertTrue(vr.getMessage(), vr.isValid());
//        System.out.println(validator.getRepairedAndUnifiedOutput());
//    }
