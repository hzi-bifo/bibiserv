...
static final long[] jjbitVec9 = {
   0x0L, 0x0L, 0x0L, 0xffffffffff7fffffL
};
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 8:
                  ...
                  break;
               case 9:
                  if ((0xdc00ecf200000000L & l) != 0L && kind > 19)
                     kind = 19;
                  break;
               case 10:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 7:
                  ...
                  break;
               case 9:
                  if ((0x50000001f8000000L & l) != 0L && kind > 19)
                     kind = 19;
                  break;
               default : break;
            }
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 6:
                  ...
                  break;
               case 7:
                  if (jjCanMove_1(hiByte, i1, i2, l1, l2) && kind > 17)
                     kind = 17;
                  break;
               case 8:
...
/** Constructor. */
public BibtexParserTokenManager(JavaCharStream stream){
...
/** Constructor. */
public BibtexParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
