...
/**
 * MSF to FASTA Converter
 * 
 * @author Madis Rumming (initial implemenation) 
 *         Jan Krueger - jkrueger(aet)cebitec.uni-bielfeld.de
 */
public class MSF2FASTA extends SequenceParserBasedFormatConverter {
    {
        parserinputformat = ParserInputFormat.MSF;
        inputformatdescription = "GCG/MSF as 'java.lang.String'";
        parseroutputformat = ParserOutputFormat.Fasta;
        outputformatdescription = "Fasta/Pearson as 'java.lang.String'";
