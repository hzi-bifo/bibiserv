 ...
 */
public class PHYLIP2FASTA extends SequenceParserBasedFormatConverter {

    {
        parserinputformat = ParserInputFormat.PHYLIP;
        inputformatdescription = "Phylip as 'java.lang.String'";
