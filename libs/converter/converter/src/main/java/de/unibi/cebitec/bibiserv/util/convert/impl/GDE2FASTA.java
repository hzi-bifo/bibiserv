...
/**
 * GDE to FASTA Converter
 * 
 * @author Madis Rumming (initial implemenation) 
 *         Jan Krueger - jkrueger(aet)cebitec.uni-bielfeld.de
 */
public class GDE2FASTA extends SequenceParserBasedFormatConverter {

    {
        parserinputformat = ParserInputFormat.GDE;
        inputformatdescription = "GDE as 'java.lang.String'";
