...
/**
 * RSF to FASTA Converter
 * 
 * @author Madis Rumming (initial implemenation) 
 *         Jan Krueger - jkrueger(aet)cebitec.uni-bielfeld.de
 */
public class RSF2FASTA extends SequenceParserBasedFormatConverter {

    {
        parserinputformat = ParserInputFormat.RSF;
        inputformatdescription = "GCG/RSF as 'java.lang.String'";
