...
/**
 * IG to FASTA Converter
 * 
 * @author Madis Rumming (initial implemenation) 
 *         Jan Krueger - jkrueger(aet)cebitec.uni-bielfeld.de
 */
public class IG2FASTA extends SequenceParserBasedFormatConverter {

    {
        parserinputformat = ParserInputFormat.IG;
        inputformatdescription = "IG as 'java.lang.String'";
