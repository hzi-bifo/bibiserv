...
/**
 * Fasta 2 GenBank converter
 * 
 * @author  Richard Madsack (initial release)
 *          Jan Krueger - jkrueger(aet)cebitec.uni-bielefeld.de
 */
public class FASTA2GENBANK extends SimpleFormatConverter{
    {
     formatdescription =  "GenBank as 'java.lang.String'";
     outputformat = InputFormat.GenBank;   
    }
}
