...
/**
 * Fasta 2 SWISSPROT converter
 * 
 * @author  Richard Madsack (initial release)
 *          Jan Krueger - jkrueger(aet)cebitec.uni-bielefeld.de
 */
public class FASTA2SWISSPROT extends SimpleFormatConverter{
    {
        formatdescription = "EMBL as 'java.lang.String'";
        outputformat = InputFormat.EMBL;
    }
}