...
/**
 * Fasta 2 CODATA converter
 * 
 * @author  Richard Madsack (initial release)
 *          Jan Krueger - jkrueger(aet)cebitec.uni-bielefeld.de
 */
public class FASTA2CODATA extends SimpleFormatConverter{
    {
        formatdescription = "COData as 'java.lang.String'";
        outputformat = InputFormat.CODATA;
    } 
}
