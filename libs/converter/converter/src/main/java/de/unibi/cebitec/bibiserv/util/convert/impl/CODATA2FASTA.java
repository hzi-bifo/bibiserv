...
/**
 * CODATA to Fasta Converter
 * 
 * @author  Madis Rumming - mrumming(aet)cebitec.uni-bielefeld.de (initial release)
 *          Jan Krueger - jkrueger(aet)cebitec.uni-bielefeld.de
 */
public class CODATA2FASTA extends SimpleFormatConverter {
