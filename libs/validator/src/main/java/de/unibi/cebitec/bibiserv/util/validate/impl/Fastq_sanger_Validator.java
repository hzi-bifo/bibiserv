 ...
 */
public class Fastq_sanger_Validator implements Validator {
    ...
    public ValidationResult validateThis(Object data) {
        ...
        return new ValidationResult(validator.validate(input, FastQVariants.Sanger),validator.getValidationMessage());
    }
