...
/**
 * A simple validator for fastq variant sanger.
 * @author Thomas Gatter - tgatter@cebitec.techfak.uni-bielefeld.de
 */
public class Fastq_solexa_Validator implements Validator {
    ...
    public ValidationResult validateThis(Object data) {
        ...
        return new ValidationResult(validator.validate(input, FastQVariants.Solexa),validator.getValidationMessage());
    }
