...
import de.unibi.cebitec.bibiserv.sequenceparser.enums.MsfType;
...
public class MsfParser extends Parser {
    ...
    private static final Logger LOG = Logger.getLogger(MsfParser.class);
    ...
    private boolean collectSequences(int seqCount) {
        HashMap<String, StringBuilder> hTemp = new HashMap<>();
        try {
