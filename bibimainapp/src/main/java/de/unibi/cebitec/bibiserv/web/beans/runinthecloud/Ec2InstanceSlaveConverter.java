 ...
 */
public class Ec2InstanceSlaveConverter implements Converter {

    private Ec2InstanceWizard ec2InstanceWizard;

    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (ec2InstanceWizard != null && !ec2InstanceWizard.getPossibleHVMEc2SlaveInstances().isEmpty()) {
            for (Object ec2 : ec2InstanceWizard.getPossibleHVMEc2SlaveInstances()) {
